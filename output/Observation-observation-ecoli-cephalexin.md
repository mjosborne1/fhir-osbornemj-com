# Observation - E. coli Cephalexin Susceptibility - FHIR Implementation Guide for PUBLIC Testing v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation - E. coli Cephalexin Susceptibility**

## Example Observation: Observation - E. coli Cephalexin Susceptibility
...
```json
{
  ...
  "id" : "observation-ecoli-cephalexin",
  "meta" : {
