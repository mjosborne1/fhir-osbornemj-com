# Encounter - Female ED Presentation - FHIR Implementation Guide for PUBLIC Testing v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Encounter - Female ED Presentation**

## Example Encounter: Encounter - Female ED Presentation

Profile: [AU Core Encounter](http://hl7.org.au/fhir/core/2.0.0/StructureDefinition-au-core-encounter.html)

**identifier**: Visit number/2964051 (use: official, )
...
```json
{
  ...
  "identifier" : [{
    ...
    "system" : "http://fhir.osbornemj.com/id/visitno",
    "value" : "2964051"
  }],
  "status" : "finished",
  "class" : {
  ...
  "type" : [{
    "coding" : [{
      "system" : "http://fhir.osbornemj.com/cs/qh-encounter-types",
      "code" : "E"
    }],
