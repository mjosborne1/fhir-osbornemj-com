# Observation - E. coli Colony Count - FHIR Implementation Guide for PUBLIC Testing v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observation - E. coli Colony Count**

## Example Observation: Observation - E. coli Colony Count
...
```json
{
  ...
  "id" : "observation-ecoli-colonycount",
  "meta" : {
